...
API_ID = int(environ.get('API_ID', '23833905463'))
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002167701223') # give your force subscribe channel id here else leave it blank
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002182291545')
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://crchoudharyji1122:<Chenaram@2003>@cluster0.cuje2.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
DATABASE_NAME = environ.get('DATABASE_NAME', "crchoudharyji1122")
...
OWNER_USERNAME = environ.get('OWNER_USERNAME', 'CHOUDHARY_ji_AK47') # owner username without @
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'JAAT4748') # Support Chat Link Without https:// or @
